...
function Navbar (props) {
  return <nav className="sticky top-0 z-50  bg-blur-md flex items-center justify-between w-full max-w-3xl py-6 mx-auto my-6 text-gray-500 dark:text-cullen box-border leading-5 transition ease-in ">
